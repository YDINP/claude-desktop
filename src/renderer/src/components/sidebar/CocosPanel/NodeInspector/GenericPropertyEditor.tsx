...
const COMP_SKIP: Record<string, Set<string>> = {
  ...
  'cc.LabelOutline': new Set(['string', '_string', 'fontSize', 'lineHeight', 'fontFamily', 'font', '_N$file', 'isSystemFontUsed', 'horizontalAlign', '_N$horizontalAlign', 'verticalAlign', 'overflow', '_N$overflow', 'cacheMode', 'isBold', 'isItalic', 'isUnderline', 'color', '_color', '_N$color', 'spacingX', '_spacingX', '_N$spacingX', 'spacingY', '_spacingY', '_N$spacingY', 'enableWrapText', '_enableWrapText', '_N$enableWrapText']),
  'cc.LabelShadow': new Set(['string', '_string', 'fontSize', 'lineHeight', 'fontFamily', 'font', '_N$file', 'isSystemFontUsed', 'horizontalAlign', '_N$horizontalAlign', 'verticalAlign', 'overflow', '_N$overflow', 'cacheMode', 'isBold', 'isItalic', 'isUnderline', 'color', '_color', '_N$color', 'spacingX', '_spacingX', '_N$spacingX', 'spacingY', '_spacingY', '_N$spacingY', 'enableWrapText', '_enableWrapText', '_N$enableWrapText']),
  ...
  'cc.Sprite2D': new Set(['spriteFrame', '_spriteFrame', 'type', 'sizeMode', 'trim', 'grayscale', '_N$type', '_N$sizeMode', '_N$trim', '_N$grayscale']),
  'cc.Graphics': new Set(['spriteFrame', '_spriteFrame', 'type', 'sizeMode', 'trim', 'grayscale', '_N$type', '_N$sizeMode', '_N$trim', '_N$grayscale']),
  'cc.VideoPlayer': new Set(['spriteFrame', '_spriteFrame', 'type', 'sizeMode', 'trim', 'grayscale', '_N$type', '_N$sizeMode', '_N$trim', '_N$grayscale']),
  'cc.WebView': new Set(['spriteFrame', '_spriteFrame', 'type', 'sizeMode', 'trim', 'grayscale', '_N$type', '_N$sizeMode', '_N$trim', '_N$grayscale']),
  'cc.TiledMap': new Set(['spriteFrame', '_spriteFrame', 'type', 'sizeMode', 'trim', 'grayscale', '_N$type', '_N$sizeMode', '_N$trim', '_N$grayscale']),
  'cc.TiledLayer': new Set(['spriteFrame', '_spriteFrame', 'type', 'sizeMode', 'trim', 'grayscale', '_N$type', '_N$sizeMode', '_N$trim', '_N$grayscale']),
  'cc.Button': new Set(['interactable', 'transition', 'duration', 'zoomScale', 'normalColor', 'pressedColor', 'hoverColor', 'disabledColor']),
  'cc.Toggle': new Set(['isChecked', '_isChecked', '_N$isChecked', 'enabled', '_enabled']),
  'cc.ToggleContainer': new Set(['allowSwitchOff', 'autoCheckToggle', '_autoCheckToggle', '_N$autoCheckToggle', 'enabled', '_enabled']),
  'cc.EditBox': new Set(['string', '_string', '_N$string', 'placeholder', 'maxLength', '_maxLength', '_N$maxLength', 'fontSize', '_fontSize', '_N$fontSize', 'inputMode', '_inputMode', '_N$inputMode', 'inputFlag', '_inputFlag', '_N$inputFlag', 'returnType', '_returnType', 'lineCount', '_lineCount', '_N$lineCount', 'tabIndex', '_tabIndex', 'fontColor', '_fontColor', '_N$fontColor', 'placeholderFontColor', '_placeholderFontColor', '_N$placeholderFontColor', 'placeholderFontSize', '_placeholderFontSize', '_N$placeholderFontSize', 'enabled', '_enabled']),
  'cc.Slider': new Set(['progress', '_progress', '_N$progress', 'direction', '_direction', '_N$direction', 'minValue', '_minValue', 'maxValue', '_maxValue', 'step', '_step', 'enabled', '_enabled']),
  ...
  'cc.Canvas': new Set(['resizeWithBrowserSize', '_resizeWithBrowserSize', '_N$resizeWithBrowserSize', 'enabled', '_enabled']),
  ...
  'cc.BlockInputEvents': new Set(['enabled', '_enabled']),
  ...
  'cc.ParticleSystem': new Set(['duration', '_duration', 'emissionRate', '_emissionRate', 'loop', '_loop', 'playOnLoad', '_playOnLoad', 'autoRemoveOnFinish', '_autoRemoveOnFinish', 'maxParticles', '_maxParticles', 'life', '_life', 'lifeVar', '_lifeVar', 'startColor', '_startColor', 'startColorVar', '_startColorVar', 'endColor', '_endColor', 'endColorVar', '_endColorVar', 'angle', '_angle', 'angleVar', '_angleVar', 'speed', '_speed', 'speedVar', '_speedVar', 'posVar', '_posVar', 'gravity', '_gravity', 'radialAccel', '_radialAccel', 'radialAccelVar', '_radialAccelVar', 'startSize', '_startSize', 'startSizeVar', '_startSizeVar', 'endSize', '_endSize', 'endSizeVar', '_endSizeVar', 'startSpin', '_startSpin', 'startSpinVar', '_startSpinVar', 'endSpin', '_endSpin', 'endSpinVar', '_endSpinVar', 'emitterMode', '_emitterMode', 'positionType', '_positionType', 'simulationSpace', '_simulationSpace', 'enabled', '_enabled']),
  'cc.ParticleSystem2D': new Set(['duration', '_duration', 'emissionRate', '_emissionRate', 'loop', '_loop', 'playOnLoad', '_playOnLoad', 'autoRemoveOnFinish', '_autoRemoveOnFinish', 'maxParticles', '_maxParticles', 'life', '_life', 'lifeVar', '_lifeVar', 'startColor', '_startColor', 'endColor', '_endColor', 'angle', '_angle', 'angleVar', '_angleVar', 'speed', '_speed', 'speedVar', '_speedVar', 'gravity', '_gravity', 'radialAccel', '_radialAccel', 'emitterMode', '_emitterMode', 'enabled', '_enabled']),
  'cc.Animation': new Set(['defaultClipName', '_defaultClipName', 'playOnLoad', '_playOnLoad', 'loop', '_loop', 'speed', '_speed', 'sample', '_sample', 'wrapMode', '_wrapMode', 'enabled', '_enabled']),
  'cc.SkeletalAnimation': new Set(['defaultClipName', '_defaultClipName', 'playOnLoad', '_playOnLoad', 'loop', '_loop', 'speed', '_speed', 'sample', '_sample', 'wrapMode', '_wrapMode', 'enabled', '_enabled']),
  'dragonBones.ArmatureDisplay': new Set(['armatureName', 'animationName', 'defaultSkin', 'playTimes', 'timeScale', 'premultipliedAlpha', 'debugBones', 'debugSlots', 'enableBatch', '_enableBatch', '_N$enableBatch', 'enabled', '_enabled']),
  'sp.Skeleton': new Set(['animationName', 'defaultCachingMode', '_defaultCachingMode', 'loop', '_loop', 'speed', 'speedRatio', 'timeScale', 'paused', 'useTint', '_useTint', 'enableBatch', '_enableBatch', '_N$enableBatch', 'enabled', '_enabled']),
  'cc.ScrollView': new Set(['horizontal', '_horizontal', '_N$horizontal', 'vertical', '_vertical', '_N$vertical', 'inertia', '_inertia', '_N$inertia', 'elastic', '_elastic', '_N$elastic', 'brake', '_brake', '_N$brake', 'pagingEnabled', '_pagingEnabled', '_N$pagingEnabled', 'cancelInnerEvents', '_cancelInnerEvents', '_N$cancelInnerEvents', 'scrollDuration', '_scrollDuration', '_N$scrollDuration', 'elasticDuration', '_elasticDuration', '_N$elasticDuration', 'bounceTime', '_bounceTime', '_N$bounceTime', 'bounceDuration', '_bounceDuration', '_N$bounceDuration', 'hideScrollBar', '_hideScrollBar', '_N$hideScrollBar', 'mouseWheelScrollSensitivity', '_mouseWheelScrollSensitivity', '_N$mouseWheelScrollSensitivity', 'speedAmplifier', '_speedAmplifier', '_N$speedAmplifier', 'bounce', '_bounce', '_N$bounce', 'enabled', '_enabled']),
  'cc.Scrollbar': new Set(['direction', '_direction', '_N$direction', 'enableAutoHide', '_enableAutoHide', '_N$enableAutoHide', 'autoHideTime', '_autoHideTime', '_N$autoHideTime', 'enabled', '_enabled']),
  'cc.PageView': new Set(['direction', '_direction', '_N$direction', 'scrollThreshold', '_scrollThreshold', '_N$scrollThreshold', 'autoPageTurningThreshold', '_autoPageTurningThreshold', '_N$autoPageTurningThreshold', 'pageTurningSpeed', '_pageTurningSpeed', '_N$pageTurningSpeed', 'slideDuration', '_slideDuration', '_N$slideDuration', 'effectType', '_effectType', '_N$effectType', 'autoPlay', '_autoPlay', '_N$autoPlay', 'autoPageTurningInterval', '_autoPageTurningInterval', '_N$autoPageTurningInterval', 'pageTurningEventTiming', '_pageTurningEventTiming', '_N$pageTurningEventTiming', 'speedAmplifier', '_speedAmplifier', '_N$speedAmplifier', 'bounceEnabled', '_bounceEnabled', '_N$bounceEnabled', 'enabled', '_enabled']),
  'cc.PageViewIndicator': new Set(['direction', '_direction', '_N$direction', 'spacingX', '_spacingX', '_N$spacingX', 'spacingY', '_spacingY', '_N$spacingY', 'enabled', '_enabled']),
  'cc.BoxCollider': new Set(['density', '_density', 'friction', '_friction', 'tag', '_tag', 'offset', '_offset', 'enabled', '_enabled']),
  'cc.BoxCollider2D': new Set(['density', '_density', 'friction', '_friction', 'tag', '_tag', 'offset', '_offset', 'enabled', '_enabled']),
  'cc.CircleCollider': new Set(['density', '_density', 'friction', '_friction', 'tag', '_tag', 'offset', '_offset', 'radius', '_radius', 'enabled', '_enabled']),
  'cc.CircleCollider2D': new Set(['density', '_density', 'friction', '_friction', 'tag', '_tag', 'offset', '_offset', 'radius', '_radius', 'enabled', '_enabled']),
  'cc.PolygonCollider': new Set(['density', '_density', 'friction', '_friction', 'tag', '_tag', 'offset', '_offset', 'enabled', '_enabled']),
  'cc.PolygonCollider2D': new Set(['density', '_density', 'friction', '_friction', 'tag', '_tag', 'offset', '_offset', 'enabled', '_enabled']),
  'cc.RigidBody': new Set(['allowSleep', '_allowSleep', 'angularDamping', 'linearDamping', 'gravityScale', 'fixedRotation', 'awake', '_awake', 'bullet', '_bullet', 'angularVelocity', '_angularVelocity', 'linearVelocity', '_linearVelocity', 'mass', '_mass', 'enabled', '_enabled']),
  'cc.RigidBody2D': new Set(['allowSleep', '_allowSleep', 'angularDamping', 'linearDamping', 'gravityScale', 'fixedRotation', 'awake', '_awake', 'bullet', '_bullet', 'angularVelocity', '_angularVelocity', 'linearVelocity', '_linearVelocity', 'mass', '_mass', 'enabled', '_enabled']),
}
