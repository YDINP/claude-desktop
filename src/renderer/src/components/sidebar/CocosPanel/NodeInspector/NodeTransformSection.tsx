...
/** 앵커 9-point 프리셋: [anchorX, anchorY] pairs (좌상단→우하단 순) */
const ANCHOR_PRESETS: Array<[number, number]> = [
  [0, 1], [0.5, 1], [1, 1],     // top row: TL, TC, TR
  [0, 0.5], [0.5, 0.5], [1, 0.5], // mid row: ML, MC, MR
  [0, 0], [0.5, 0], [1, 0],     // bot row: BL, BC, BR
]
